...
As a Mars website user, I want to add, edit and delete Skill records in my profile
...
Scenario: Add a Skill record in Profile details
	...
	| Dancing  |              | Please enter skill and experience level |
	...
	| Jmeter   |              | Please enter skill and experience level  |
	|          |              | Please enter skill and experience level  |
