...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "SkillFeature", "As a Mars user, I want to add, edit and delete Skill records in my profile\r\nso th" +
                    "at I can manage my profile details successfully ", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.TestCaseAttribute("Python", "Expert", "This skill is already exist in your skill list.", null)]
        [NUnit.Framework.TestCaseAttribute("", "Beginner", "Please enter skill and experience level", null)]
        [NUnit.Framework.TestCaseAttribute("Dancing", "Choose Skill Level", "Please enter skill and experience level", null)]
...
#line hidden
#line 10
 testRunner.When(string.Format("I click on Add New button and add \'{0}\' and \'{1}\'", skill, skillLevel), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 11
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Painting", "Intermediate", "This skill is already added to your skill list.", null)]
        [NUnit.Framework.TestCaseAttribute("", "Expert", "Please enter skill and experience level", null)]
        [NUnit.Framework.TestCaseAttribute("Jmeter", "Skill Level", "Please enter skill and experience level", null)]
        [NUnit.Framework.TestCaseAttribute("", "Skill Level", "Please enter skill and experience level", null)]
